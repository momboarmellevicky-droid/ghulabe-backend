  ...
  />
      ...
      >
        {isProcessingPayment ? (lang === 'fr' ? 'Paiement en cours...' : 'Processing payment...') : t.step2Pay}
                ...
                <button onClick={() => setRecruitStep(3)} style={{position:'fixed', bottom:80, right:10, opacity:0.3, fontSize:10, zIndex:9999, background:'#000', color:'#fff', padding:'4px 8px', borderRadius:4}}>DEV: skip→3</button>
              </div>
            </div>
          )}
