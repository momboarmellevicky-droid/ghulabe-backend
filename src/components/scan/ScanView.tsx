...
export const GhulabeBackend = {
  ...
  async startScan(url: string, legalCheckboxAccepted: boolean, token?: string): Promise<ScanResult> {
    ...
    // Adaptateur : le backend renvoie "scanId" et "duration_seconds", le frontend
    // attend "id" et "scan_duration_seconds" (interface ScanResult, types.ts).
    // Sans ce mapping, le temps de scan et l'id restent undefined à l'affichage.
    return {
      ...data,
